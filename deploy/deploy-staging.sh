#!/bin/bash
# ============================================================
# developerOS — Staging Deploy Script
...
SERVER="root@158.220.99.54"
SSH_OPTS="-i $HOME/.ssh/developeros_staging"
APP_DIR="/opt/developerOS"
WEB_DIR="/var/www/developeros"
COMPOSE_FILE="docker-compose.staging.yml"
NGINX_CONF="deploy/nginx/staging.conf"
export RSYNC_RSH="ssh $SSH_OPTS"

echo "============================================================"
echo "  Deploying developerOS to STAGING"
echo "  Server: $SERVER"
echo "============================================================"
echo ""
...
for URL in "https://api-staging.developeros.pro/api/health/" "https://staging.developeros.pro" "https://console-staging.developeros.pro"; do
...
echo "============================================================"
echo "  API:     https://api-staging.developeros.pro"
echo "  App:     https://staging.developeros.pro"
echo "  Console: https://console-staging.developeros.pro"
echo "============================================================"
